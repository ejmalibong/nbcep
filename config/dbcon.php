...
$serverName = "NBCP-LT-144\SQLEXPRESS";
...
// $connJs = sqlsrv_connect($serverName, $connectionInfoJs);

// if ($conn) {
//      echo "Connection established to Leave Database.<br />";
// } else {
//      echo "Connection could not be established to Leave Database.<br />";
//      die(print_r(sqlsrv_errors(), true));
// }

// if ($connJs) {
//      echo "Connection established to Jeonsoft Database.<br />";
// } else {
//      echo "Connection could not be established to Jeonsoft Database.<br />";
//      die(print_r(sqlsrv_errors(), true));
// }
